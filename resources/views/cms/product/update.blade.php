            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <img src="{{asset($data->photo)}}" class="w-100">
                    </div>
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="size" class="form-control" name="size" value="{{ $data->size }}" placeholder="input size...">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="stok" class="form-control" name="stok" value="{{ $data->stok }}" placeholder="input stok...">
                                </div>
                            </div>
                        </div>
                        <div class="row">
