            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label class="" for="btn-img-upload">{{ __('Gambar Kategori Tersedia') }}</label>
                        <img src="{{asset('storage/' . $data->photo)}}" class="w-100">
                    </div>
                    <div class="form-group">
                        <label class="" for="btn-img-upload">{{ __('Upload Gambar Kategori Baru') }}</label>
                ...
                <div class="card-body">
                    ...
                    <div class="pl-lg-4">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label" for="name">{{ __('Nama Kategori') }}<span class="small text-danger">*</span></label>
